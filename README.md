...
[![Build Status](https://travis-ci.org/gab1one/knime-activelearning.svg?branch=master)](https://travis-ci.org/gab1one/knime-activelearning)
[![SonarCloud Gate](https://sonarcloud.io/api/badges/gate?key=de.gab1one.knime:active-learning)](https://sonarcloud.io/dashboard?id=de.gab1one.knime:active-learning)
[![SonarCloud Coverage](https://sonarcloud.io/api/badges/measure?key=de.gab1one.knime:active-learning&metric=coverage)](https://sonarcloud.io/component_measures/domain/Coverage?id=de.gab1one.knime:active-learning)
...
* KNIME, https://www.knime.org, version 3.6 or higher

Steps to get the TestNode KNIME node inside KNIME:
...
4. Install m2e (Maven integration for Eclipse) + Test workflows in JUnit
    ...
    2. Make sure the following Software Sites (or a version of them) are present otherwise add them:
      ...
      * http://update.knime.org/analytics-platform/3.6
